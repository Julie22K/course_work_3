                    ...
                    <form action="{{route('goods.update')}}" method="post">
                        ...
                        <div class="flex flex-row justify-between">
                            <div class="m-2">
                                ...
                                <input type="text" name="name" class="border border-gray-400 px-4 py-2 rounded w-full focus:outline-none focus:border-teal-400" id="name" value="{{$good->name}}">
                            </div>
                            <div class="m-2">
                        ...
                        <div class="flex flex-row justify-between">
                            <div class="m-2">
                                ...
                                <input type="tel" name="phone" class="border border-gray-400 px-4 py-2 rounded w-full focus:outline-none focus:border-teal-400" id="phone">
                            </div>
                            <div class="m-2">
                                <label for="email" class="form-label">Електрона адреса:</label>
                                <input type="email" name="email" class="border border-gray-400 px-4 py-2 rounded w-full focus:outline-none focus:border-teal-400" id="email">
                            </div>
                        </div>
