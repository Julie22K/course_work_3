            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <button class="bg-green-400 rounded-md m-2 p-2 px-2 text-white hover:bg-green-300"
                            onclick="location.href='{{URL::route('categories.create')}}'">Додати
                    </button>
                    <table id="myTable">
                        <thead>
                        <tr>
                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td class="flex flex-row">
                                    <ion-icon onclick="location.href='{{URL::route('categories.edit',$category->id)}}'"
                                              class="bg-blue-400 rounded-md m-1 p-1 text-white hover:bg-blue-300"
                                              name="create-outline" title="Редагувати"></ion-icon>
                                    <ion-icon
                                        onclick="location.href='{{URL::route('categories.destroy',$category->id)}}'"
