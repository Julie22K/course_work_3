            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <button class="bg-green-400 rounded-md m-2 p-2 px-2 text-white hover:bg-green-300"
                            onclick="location.href='{{URL::route('employee.index')}}'">До списку
                    </button>
                    <form action="{{route('employee.store')}}" method="post">
                        ...
                        <div class="flex flex-row w-full justify-between">
                            <div class="m-2 w-1/2">
                                ...
                                <input type="phone" name="phone" class="border border-gray-400 px-4 py-2 rounded focus:outline-none focus:border-teal-400" id="phone">
                            </div>
                        </div>
                        <div class="flex flex-row w-full justify-between">

                            <label for="shop" class="form-label">Магазин:</label>
                            <select name="shop" class="border border-gray-400 m-2 px-4 py-2 rounded w-full focus:outline-none focus:border-teal-400" id="shop">
